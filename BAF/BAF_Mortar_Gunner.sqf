...
player addSecondaryWeaponItem "UK3CB_BAF_1Rnd_60mm_Mo_Shells";
...
for "_i" from 1 to 4 do {player addItemToBackpack "UK3CB_BAF_1Rnd_60mm_Mo_Shells";};
for "_i" from 1 to 4 do {player addItemToBackpack "UK3CB_BAF_1Rnd_60mm_Mo_AB_Shells";};
