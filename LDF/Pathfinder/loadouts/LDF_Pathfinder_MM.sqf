...
player addPrimaryWeaponItem "muzzle_snds_B_lush_F";
...
for "_i" from 1 to 2 do {player addItemToVest "ACE_20Rnd_762x51_Mag_SD";};
for "_i" from 1 to 2 do {player addItemToVest "ACE_20Rnd_762x51_Mag_tracer_green";};
